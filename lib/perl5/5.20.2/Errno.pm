...
"x86_64-linux-3.18.18-1-manjaro" or
	die "Errno architecture (x86_64-linux-3.18.18-1-manjaro) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
