...
## Package name      : perl5
## Source directory  : .
## Configuration time: Sat Aug  8 17:03:27 UTC 2015
## Configured by     : oselte
## Target system     : linux manjaro 3.18.18-1-manjaro #1 smp preempt fri jul 10 22:02:30 utc 2015 x86_64 gnulinux 
#
...
ccversion=''
cf_by='oselte'
cf_email='oselte@manjaro.nonet'
cf_time='Sat Aug  8 17:03:27 UTC 2015'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
libsfiles=' libnsl.so libnm.so libgdbm.so libdb.so libdl.so libcrypt.so libutil.so libc.so libgdbm_compat.so'
libsfound=' /tools/lib/libnsl.so /lib/../lib/libnm.so /lib/../lib/libgdbm.so /lib/../lib/libdb.so /tools/lib/libdl.so /tools/lib/libcrypt.so /tools/lib/libutil.so /tools/lib/libc.so /lib/../lib/libgdbm_compat.so'
libspath=' /mnt/lfs/tools/bin/../lib/gcc/x86_64-unknown-linux-gnu/4.9.2/include-fixed /tools/lib /usr/local/lib /lib/../lib /usr/lib/../lib /lib /usr/lib /lib64 /usr/lib64'
...
mydomain='.nonet'
myhostname='manjaro'
myuname='linux manjaro 3.18.18-1-manjaro #1 smp preempt fri jul 10 22:02:30 utc 2015 x86_64 gnulinux '
n='-n'
need_va_copy='define'
...
perladmin='oselte@manjaro.nonet'
perllibs='-lm'
perlpath='/tools/bin/perl'
pg='pg'
phostname='hostname'
pidtype='pid_t'
plibpth='/lib/x86_64-unknown-linux-gnu/5.1.0 /lib/../lib /usr/lib/x86_64-unknown-linux-gnu/5.1.0 /usr/lib/../lib /lib /usr/lib'
pmake=''
pr=''
prefix='/tools'
prefixexp='/tools'
